...
import { handTechItems } from "../assets/list-details";
import "./Resedential.css";

export default function ResedentialHand() {
  ...
  function renderHomePageRightLayout() {
    return (
      <div className="list-details-con">
        <h4 className="right-layout-heading">Hand Tech</h4>
        {handTechItems.map((item) => {
          return (
            <div key={item.name}>
